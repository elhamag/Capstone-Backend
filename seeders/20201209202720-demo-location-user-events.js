...
module.exports = {
  up: async (queryInterface, Sequelize) => {
    ...
    let events = await queryInterface.bulkInsert("Events", [
      ...
      { name: "Visions: A Nutcracker Experience", description: "Generations of dancers have passed through this Chicago institution. Founded by Chicago heiress and historically significant ballerina Ruth Page, the school took over a former Moose Lodge, which now houses several studios and a small theater. Although ballet is the house specialty, jazz, Pilates and yoga are also offered. Morning classes are geared toward professionals and enthusiasts.", location: "1016 N Dearborn St, Chicago", foodServe: false, capacity: 50, maxCapacity: 70, locationId: 1 },
      { name: "Justin Bieber in Inglewood", description: "There is no description for this event.", location: "3900 West Manchester Boulevard Inglewood, California 90305", foodServe: false, capacity: 230, maxCapacity: 500, locationId: 2 },
      { name: "Doobie Brothers (Rescheduled from 9/18/2020) in Inglewood", description: "There is no description for this event.", location: "3900 West Manchester Boulevard Inglewood, California 90305", foodServe: false, capacity: 150, maxCapacity: 500, locationId: 2 },
